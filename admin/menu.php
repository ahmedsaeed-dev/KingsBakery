...
function getRecords($conn){
	...
	if ($result->num_rows > 0) {
		...
		while($row = $result->fetch_assoc()) { ?>
			  <tr>
        <td><a href="products.php?edit=1&id=<?=$row['id']?>&page=menu" class="btn btn-default"><i class="far fa-edit"></a></td>
        <td><?=$row['name'];?></td>
      ...
      <div class="container-fluid">
        ...
        if(isset($_POST['update'])){
          ...
          if ($conn->query($sql) === TRUE) {
            header("location: $page.php?clear=1");
          } else {
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              ...
              <a class="btn btn-success float-right" id="add-product-btn" href="products.php?add=1&page=menu">Add Product</a>
