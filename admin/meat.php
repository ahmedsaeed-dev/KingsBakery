...
function getRecords($conn){
	...
	if ($result->num_rows > 0) {
		...
		while($row = $result->fetch_assoc()) { ?>
			  <tr>
        <td><a href="products.php?edit=1&id=<?=$row['id']?>&page=meat" class="btn btn-default"><i class="far fa-edit"></a></td>
        <td><?=$row['name'];?></td>
    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Meat Items</li>
        </ol>
        ...
        if(isset($_POST['update'])){
          ...
          if ($conn->query($sql) === TRUE) {
            header("location: meat.php?clear=1");
          } else {
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              ...
              <a class="btn btn-success float-right" id="add-product-btn" href="products.php?add=1&page=meat">Add Product</a>
